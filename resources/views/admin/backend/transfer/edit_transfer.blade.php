                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group w-100">
                                                ...
                                                <select name="from_warehouse_id" id="warehouse_id" class="form-control form-select" disabled> <!-- Disable to prevent user from changing warehouse on edit,user can just see -->
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group w-100">
                                                <label class="form-label" for="formBasic">Warehouse : <span class="text-danger">*</span></label>
                                                <select name="to_warehouse_id" id="warehouse_id" class="form-control form-select" disabled> <!-- Disable to prevent user from changing warehouse on edit,user can just see -->
                                                    <option value="">Select Warehouse</option>
                                                    @foreach ($warehouses as $item)
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group w-100">
                                                ...
                                                <select name="status" id="status" class="form-control form-select">
                                                    ...
                                                    <option value="Transferred" {{ $editData->status == 'Transferred' ? 'selected' : '' }}>Transferred</option>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
       ...
       function updateGrandTotal() {
          ...
          // Update due amount whenever grand total changes
          updateDueAmount();
       }
       
       // Due amount update function
